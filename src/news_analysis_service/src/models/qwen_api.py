...
class QwenCompletionRequest(BaseModel):
    ...
    messages: Annotated[
        list[ChatMessage],
        Field(..., title="A list of messages comprising the conversation so far"),
    ]
...
class Choice(BaseModel):
    ...
    message: Annotated[
        ChatMessage,
        Field(..., title="A chat completion message generated by the model"),
    ]
...
class QwenCompletionResponse(BaseModel):
    ...
    created: Annotated[
        ...
        Field(
            ...,
            title="The Unix timestamp (in sec) of when the chat completion was created",
        ),
    ]
...
class QwenModelData(BaseModel):
    ...
    id: Annotated[
        ...
        Field(
            ...,
            title="The model identifier, which can be referenced in the API endpoints",
        ),
    ]
    object: Annotated[
        Literal["model"],
        Field("model", title="The object type, which is always 'model'"),
    ]
    created: Annotated[
        int,
        Field(..., title="The Unix timestamp (in seconds) when the model was created"),
    ]
