...
class QwenCompletionResponse(BaseModel):
    ...
    References: https://platform.openai.com/docs/api-reference/chat/object
    """
...
class QwenModelData(BaseModel):
    ...
    References: https://platform.openai.com/docs/api-reference/models/object
    """

    id: Annotated[str, Field(..., title="The model identifier")]
    object: Annotated[Literal["model"], Field("model", title="The object type")]
...
class QwenModelsResponse(BaseModel):
    ...
    References: https://platform.openai.com/docs/api-reference/models/list
    """
