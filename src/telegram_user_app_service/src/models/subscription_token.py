...
class SubscriptionToken(BaseModel):
    ...
    token: Annotated[str, Field(..., title="Token", description="The generated subscription token.")]
    user_id: Annotated[
        int | None, Field(default=None, title="User ID", description="Linked user ID once the token is activated.")
    ] = None
    created_at: Annotated[datetime, Field(..., title="Creation Timestamp")]
    activated_at: Annotated[datetime | None, Field(default=None, title="Activation Timestamp")]
